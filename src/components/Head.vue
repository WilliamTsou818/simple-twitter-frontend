<template>
  <div class="head">
    ...
    <div class="head__info">
      <div class="head__info__title">
        {{ title }}
      </div>
      <div v-show="account" class="head__info__account">@{{ account }}</div>
      <div v-show="count" class="head__info__count">{{ count }} 推文</div>
    </div>
    <div v-show="message" class="head__message">
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
