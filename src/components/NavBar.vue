  ...
  <div class="nav-left">
    ...
    <nav class="nav-left__nav">
      ...
      <template v-if="currentUser.role === 'user'">
        ...
        <router-link to="/user/chat/public" class="nav-left__nav__link">
          <svg
            class="nav-left__nav__icon"
            width="24"
            height="24"
        ...
        <router-link to="/user/chat/private" class="nav-left__nav__link">
          ...
          <span class="nav-left__nav__text">私人訊息 </span>
        </router-link>
